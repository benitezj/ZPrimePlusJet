...
EOSOUTPUTDIR=/store/user/benitezj/ggHbb/limits/2016_  # where the histograms will be saved from condor job
...
## script to run
HBBSCRIPT=./DAZSLE/ZPrimePlusJet/fitting/PbbJet/Hbb_create_2016.py
