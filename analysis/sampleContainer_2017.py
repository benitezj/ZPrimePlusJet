...
class sampleContainer:
    def __init__(self, name, fn, sf=1, DBTAGCUTMIN=-99., DBTAGCUT=0.9, lumi=1, isData=False, fillCA15=False, cutFormula='1',
        ...
        f_trig = ROOT.TFile.Open(
            os.environ['ZPRIMEPLUSJET_BASE']+"/analysis/ggH/TriggerEfficiencies_SingleMuon_Run2017.root", "read")
...
#        f_mutrig_GH.Close()
        ...
        f_mutrig_BCDEF = ROOT.TFile.Open(os.environ['ZPRIMEPLUSJET_BASE']+"/analysis/ggH/EfficienciesAndSF_RunBtoF_Nov17Nov2017.root", "read")
...
#        self._mutrig_eff.Add(self._mutrig_eff_BCDEF, lumi_BCDEF / lumi_total)
        ...
        with open(os.environ['ZPRIMEPLUSJET_BASE']+"/analysis/ggH/RunBCDEF_data_ID.json") as ID_input_file:
                self._muid_eff = json.load(ID_input_file)


        # get muon ISO efficiency object

	with open(os.environ['ZPRIMEPLUSJET_BASE']+"/analysis/ggH/RunBCDEF_data_ISO.json") as ISO_input_file:
